    ...
    const links = (
      <ul className="sidebar-nav">
        ...
        <li className="sidebar-item">
          ...
          <ul id="travelSubMenu" class="sidebar-dropdown list-unstyled collapse">
            <li class="sidebar-item">
              <Link class="sidebar-link" to="/map">Map
                <span class="sidebar-badge badge badge-secondary">New</span>
              </Link>
            </li>
            <li class="sidebar-item">
              <Link class="sidebar-link" to="/map">Menu 2</Link>
            </li>
            <li class="sidebar-item">
              <Link class="sidebar-link" to="/map">Menu 3</Link>
            </li>
          </ul>
        </li>
      </ul>
